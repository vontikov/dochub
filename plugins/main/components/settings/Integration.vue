<template>
  <div class="intergarion-setting-profile-list">
    <div style="min-height: 64px">
      ...
      Интеграция с {{ name }} позволяет использовать его как файловое хранилище со встроенным управлением 
      версями и возможностью аудита. Вносимые изменения в репозиторий будут сразу отображаться в DocHub.
    </div>
